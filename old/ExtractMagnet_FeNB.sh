...
magnet2a=`zgrep -A 5 'magnetization (x)' $OUTCAR | tail -1 | awk '{print $5}'`
magnet6h=`zgrep -A 6 'magnetization (x)' $OUTCAR | tail -1 | awk '{print $5}'`
magnet4f=`zgrep -A 12 'magnetization (x)' $OUTCAR | tail -1 | awk '{print $5}'`
magnetTOT=`zgrep -A 17 'magnetization (x)' $OUTCAR | tail -1 | awk '{print $5}'`
