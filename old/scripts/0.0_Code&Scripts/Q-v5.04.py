...
if __name__ == '__main__':
        ...
        ForH = raw_input('Would you like to extract Enthalpy or Free energy (H:Enthalpy/F:FreeEnergy/R:FreeEnergywithFixedReference/[No]:nothing)?').upper()
        if ForH == 'F':
            Q.EofQs();
            Q.fit4TCM();
        elif ForH == 'H':
...
for i in range(Q.nC):
    f=np.loadtxt('FreeEneHarmonic/F_J_FixRef_Formula.'+str(i+1));
