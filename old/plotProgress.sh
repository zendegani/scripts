...
if [ $rms == "skip" ]; then
echo '##SKIP'
gnuplot -e "TIT='${title}'; folders='${folders}'; out='${output}'; outRMS='${outputRMS}'; outEP='${outputEP}'; COL='${C}'; LIN='${L}'; SKIP='${SKIP}'; EP='${Ep}'" /u/alizen/scripts/gnuprogressWOrms.plg
else
echo '##Plot'
gnuplot -e "TIT='${title}'; folders='${folders}'; out='${output}'; outRMS='${outputRMS}'; outEP='${outputEP}'; COL='${C}'; LIN='${L}'; SKIP='${SKIP}'; EP='${Ep}'" /u/alizen/scripts/gnuprogress.plg
fi
